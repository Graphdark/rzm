...
private:
        // constructors/destructors
            SdStrObjIdNode(LPCTSTR name, const AcDbObjectId& objId, void *pData = NULL);
...
public:
    ...
    virtual    ~SdStrObjIdList();
        ...
        // operations
            int            Count() const { return  (int)m_list.GetCount(); }
    virtual POSITION    AddHead(LPCTSTR str, const AcDbObjectId& objId, void* pData = NULL);
    virtual POSITION    AddTail(LPCTSTR str, const AcDbObjectId& objId, void* pData = NULL);
    virtual POSITION    AddAlpha(LPCTSTR str, const AcDbObjectId& objId, void* pData = NULL);
    virtual BOOL        GetAtIndex(int index, CString& str, AcDbObjectId& objId, void** pData = NULL) const;
...
private:
    ...
    BOOL        m_caseSensitive;
        ...
        // outlawed functions
    SdStrObjIdList(const SdStrObjIdList& copy);
    SdStrObjIdList&    operator=(const SdStrObjIdList& copy);
};
...
public:
    ...
    virtual void    item(CString& name, AcDbObjectId& objId, void** ppData = NULL) const;
