...
struct AcadVar {
    ...
    static const TCHAR* cmddia;
    static const TCHAR* cmdactive;
    static const TCHAR* cvport;
    static const TCHAR* filedia;
    static const TCHAR* orthomode;
    static const TCHAR* snapmode;
    static const TCHAR* snapunit;
    static const TCHAR* snapang;
    static const TCHAR* autosnap;
    static const TCHAR* viewctr;
    static const TCHAR* viewdir;
    static const TCHAR* viewsize;
    static const TCHAR* vsmax;
    static const TCHAR* vsmin;
    static const TCHAR* screensize;
    static const TCHAR* ucsicon;
    static const TCHAR* rasterpreview;
    static const TCHAR* pdmode;
    static const TCHAR* pdsize;
    static const TCHAR* limcheck;
    static const TCHAR* limmin;
    static const TCHAR* limmax;
    static const TCHAR* gridmode;
    static const TCHAR* attdia;
    static const TCHAR* attmode;
    static const TCHAR* attreq;
    static const TCHAR* lastpoint;
    static const TCHAR* osmode;
    static const TCHAR* pickstyle;
    static const TCHAR* textsize;
    static const TCHAR* expert;
    static const TCHAR* lwdisplay;
    static const TCHAR* dbmod;
};
