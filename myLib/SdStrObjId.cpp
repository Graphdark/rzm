...
SdStrObjIdNode::SdStrObjIdNode(LPCTSTR name, const AcDbObjectId& objId, void* pData)
:    m_name(name), m_objid(objId), m_pData(pData)
{
}
...
POSITION
SdStrObjIdList::AddAlpha(LPCTSTR name, const AcDbObjectId& objId, void* pData)
{
    SdStrObjIdNode* newNode = new SdStrObjIdNode(name, objId, pData);
...
POSITION
SdStrObjIdList::AddHead(LPCTSTR name, const AcDbObjectId& objId, void* pData)
{
    SdStrObjIdNode* newNode = new SdStrObjIdNode(name, objId, pData);
...
POSITION
SdStrObjIdList::AddTail(LPCTSTR name, const AcDbObjectId& objId, void* pData)
{
    SdStrObjIdNode* newNode = new SdStrObjIdNode(name, objId, pData);
    return(m_list.AddTail(static_cast<void*>(newNode)));
}
...
BOOL
SdStrObjIdList::GetAtIndex(int index, CString& str, AcDbObjectId& objId, void** ppData) const
{
    POSITION pos = m_list.FindIndex(index);
    if (pos) {
        const SdStrObjIdNode* node = static_cast<const SdStrObjIdNode*>(m_list.GetAt(pos));
        str = node->m_name;
        objId = node->m_objid;
        if (ppData)
          *ppData = node->m_pData;
...
void
SdStrObjIdListIterator::item(CString& name, AcDbObjectId& objId, void** ppData) const
{
    const SdStrObjIdNode* node = static_cast<const SdStrObjIdNode*>(m_list.GetAt(m_pos));
    ASSERT(node != NULL);
    if (!node) return;
    name = node->m_name;
    objId = node->m_objid;
