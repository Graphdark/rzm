...
#define RS_Graphic AcDbDatabase
#define RS_Document AcDbDatabase


#define RS_Vector AcGePoint2d
#define RS_Arc AcDbArc
#define RS_Block AcDbBlockTableRecord
#define RS_Circle AcDbCircle
#define RS_Ellipse AcDbEllipse
#define RS_Entity AcDbEntity
#define RS_Hatch AcDbHatch
#define RS_Image AcDbImage
#define RS_Insert AcDbBlockReference
#define RS_Layer AcDbLayerTableRecord
#define RS_Leader AcDbLeader
#define RS_Line AcDbLine
#define RS_Line AcDbLine
#define RS_MText AcDbMText
#define RS_Point AcDbPoint
#define RS_Polyline AcDbPolyline
#define RS_Solid AcDbSolid
#define RS_Spline AcDbSpline
#define RS_Text AcDbText
#define RS_Polyline AcDbPolyline
